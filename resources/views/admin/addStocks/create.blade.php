...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.addStock.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.add-stocks.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amounttoadd') ? 'is-invalid' : '' }}" type="number" name="amounttoadd" id="amounttoadd" value="{{ old('amounttoadd') }}" step="1">
