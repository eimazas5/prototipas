    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.system-settings.update", [$systemSetting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text" name="company_name" id="company_name" value="{{ old('company_name', $systemSetting->company_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vat_code') ? 'is-invalid' : '' }}" type="text" name="vat_code" id="vat_code" value="{{ old('vat_code', $systemSetting->vat_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_code') ? 'is-invalid' : '' }}" type="text" name="company_code" id="company_code" value="{{ old('company_code', $systemSetting->company_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('logo') ? 'is-invalid' : '' }}" type="text" name="logo" id="logo" value="{{ old('logo', $systemSetting->logo) }}">
                @if($errors->has('logo'))
                    <div class="invalid-feedback">
                        {{ $errors->first('logo') }}
                    </div>
